...
namespace CM3D2.AlwaysColorChangeEx.Plugin
{
    ...
    public class FileBrowser
    {
        ...
        private static string previousInputPath = string.Empty;
        private static string previousLastSelectedPath = Directory.GetCurrentDirectory();
        ...
        public void OnGUI()
        {
            ...
            try
            {
                ...
                selectedNonMatchingDirs = GUILayoutx.SelectionList(selectedNonMatchingDirs, nonMatchingDirsWithImages,
                    labelStyle, NonMatchingDirectoryClickCallback);
